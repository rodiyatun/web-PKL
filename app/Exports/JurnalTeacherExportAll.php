...
class JurnalTeacherExportAll implements FromView, WithHeadings, ShouldAutoSize, WithStyles
{
    /**
    ...
    public function view(): View
    {
        ...
        elseif (Auth::user()->user_type == User::COMPANY) {
                return view('excel.teacher_jurnal', [
                    'data' =>  TeacherJurnal::leftJoin('student_practice_places', 'teacher_jurnals.student_id', '=', 'student_practice_places.student_id')
