    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <span
                    class="symbol-label symbol-label-name font-size-h5 font-weight-bold">{{ ucfirst(substr(\Auth::user()->name ?? 'Admin', 0, 1)) }}</span>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="text-muted mt-1">
                    {{ ucfirst(session('admin_type')) ?? 'Superadmin' }}
                </div>
                <div class="navi mt-2">
                ...
                <div class="navi mt-2">
                    ...
                    <span><strong> {{ (!empty(session('du_di')) ? session('du_di') : '' ) }}</strong></span>
                </div>
            </div>
        </div>
                ...
                <div class="navi-link">
                    ...
                    <div class="navi-text">
                        ...
                        <div class="text-muted">
                            Edit Profile Settings and Change Password
                        </div>
                    </div>
                </div>
            </a>
