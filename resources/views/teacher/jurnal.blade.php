...
@section('content')
    ...
    <div class="card card-custom col-md-8">
        ...
        <!--begin::Form-->
        <form method="POST" action="{{ route('teacher.jurnal.save') }}" enctype="multipart/form-data">
            @csrf
            <div class="card-body col-md-10">
                ...
                <div class="form-group">
                    ...
                    <select name="student_id" id="" class="form-control">
                        @foreach ($data as $item)
                            <option value="{{ $item['id'] }}">{{ $item['nisn'].'-'.$item['name'] }}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" placeholder="E.g : Kegiatan Hari Senin" />
                    <span class="form-text text-muted">Isilah sesuai dengan judul jurnal.</span>
                </div>
                <div class="form-group">
                    <label>Deskripsi <span class="text-danger">*</span></label>
                    <textarea name="description" id="" class="form-control" placeholder="E.g : Kegiatan hari ini melakukan install ulang windows" cols="30" rows="10"></textarea>
